...
class Uttaradit extends StatefulWidget {
  const Uttaradit({Key key}) : super(key: key);

  @override
  State<Uttaradit> createState() => _UttaraditState();
}

class _UttaraditState extends State<Uttaradit> {
  int Page = 0;
  @override
