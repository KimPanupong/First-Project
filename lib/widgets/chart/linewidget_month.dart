...
class Widget_month extends StatefulWidget {
  const Widget_month({
    Key key,
    this.title,
    this.title1,
  ...
  @override
  State<Widget_month> createState() => _Widget_monthState();
}

class _Widget_monthState extends State<Widget_month> {
  List<chart> mydata;
                ...
                child: SfCartesianChart(
                    ...
                    series: <ChartSeries<chart, String>>[
                      LineSeries<chart, String>(
                        dataSource: mydata,
                        xValueMapper: (chart title, _) => title.countmonth,
